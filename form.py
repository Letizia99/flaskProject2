...
from wtforms import StringField,SubmitField,PasswordField, SelectField, FileField, TextAreaField, validators
...
class formRegistration(FlaskForm):
    ...
    password_con = PasswordField('Confirm your password')
...
#class CreateEvent(FlaskForm):
    ...
    #place = StringField('Place:', validators=[DataRequired(), Length(min=2, max=30)])
